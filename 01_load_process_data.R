#NOTE: FOR NOW THIS PROCESS ISN'T WORKING ONCE COMBINING STATE REACHED DUE TO LACK OF RAM/CPU RESOURCES AVAILABLE
#SO WILL SWITCH TO BIGQUERY FOR NOW AND AIM TO FIND SOLUTION TO RUN THESE LOCALLY
